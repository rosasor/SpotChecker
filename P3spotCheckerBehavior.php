	...
	<body>
		<header>
					...
					<div class="row">
						...
						<div class="col-sm-4 offset-md-1 py-4">
							<ul class="list-unstyled">
								...
								<li><a href="finalP3.php" style="font-size:15px" class="text-muted">Behavior</a></li>
			...
			<div class="navbar navbar-dark bg-dark shadow-sm">
				<div class="container">
					<a href="finalP3.php" class="navbar-brand d-flex align-items-center"><strong>Behavior</strong></a>
			...
			<section class="py-2 text-center container">
				<div class="row py-lg-3">
					...
					<div class="col-lg-6 col-md-8 mx-auto">
						<h1 class="fw-dark">The Behavior</h1>
						<hr class="featurette-divider">
					</div>

					<div class="col-lg-9 col-md-8 mx-auto">
						<h3 class="fw-light">The behavior we will be focusing on is the length of stay in a specific 30-minute spot. Our theory is that students park in the spot for at least 50 minutes because classes in McAllister are usually in 50 minute blocks. We will be looking specifically between the hours of 7am-5pm, which is when the majority of classes in this building take place.</h3>
					</div>
					...
					<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
						...
						<div class="col">
							<div class="card shadow-sm">
								<img src="images/behaviorNoCarsSquare.jpg">
								<div class="card-body">
									<p class="card-text">No cars parked in the parking spots</p>
								</div>
							</div>
						</div>
						<!-- END CARD BLOCK ONE -->
                        ...
                        <div class="col">
							<div class="card shadow-sm">
								<img src="images/viewParkingLotSquare.jpg">

								<div class="card-body">
									<p class="card-text">Various parking spots in use</p>
								</div>
							</div>
						</div>
						<!-- END CARD BLOCK TWO -->
                        ...
                        <div class="col">
							<div class="card shadow-sm">
								<img src="images/behaviorCarInSpotSquare.jpg">

								<div class="card-body">
									<p class="card-text">A parking spot in use</p>
								</div>
							</div>
						</div>
