	...
	<body>
		...
		<header>
					...
					<div class="row">
						...
						<div class="col-sm-4 offset-md-1 py-4">
							<ul class="list-unstyled">
								...
								<li><a href="finalP13.php" style="font-size:15px" class="text-muted">Kiosk Design</a></li><br>
			...
			<div class="navbar navbar-dark bg-dark shadow-sm">
				<div class="container">
					<a href="finalP13.php" class="navbar-brand d-flex align-items-center"><strong>Kiosk Design</strong></a>
			...
			<section class="py-2 text-center container">
				<div class="row py-lg-3">
					<div class="col-lg-6 col-md-8 mx-auto">
						<h1 class="fw-dark">The Design</h1>
				...
				<div class="container">
					...
					<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
						<!-- PICTURE ROW ONE -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/isometricKioskLeftSquare.png">
								</div>
							</div>
							<!-- END CARD BLOCK ONE -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/isometricKioskCenterSquare.png">
								</div>
							</div>
							<!-- END CARD BLOCK TWO -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/isometricKioskRightSquare.png">
								</div>
							</div>
						...
						<!-- PICTURE ROW TWO -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/foamKioskRightSquare.jpg">
								</div>
							</div>
							<!-- END CARD BLOCK ONE -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/foamKioskFrontSquare.jpg">
								</div>
							</div>
							<!-- END CARD BLOCK TWO -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/foamKioskLeftSquare.jpg">
								</div>
							</div>
							<!-- END CARD BLOCK THREE -->
						...
						<!-- PICTURE ROW THREE -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/lightKioskRightSquare.jpg">
								</div>
							</div>
							<!-- END CARD BLOCK ONE -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/darkKioskFrontSquare.jpg">
								</div>
							</div>
							<!-- END CARD BLOCK TWO -->
							...
							<div class="col">
								<div class="card shadow-sm">
									<img src="images/lightKioskLeftSquare.jpg">
								</div>
							</div>
							<!-- END CARD BLOCK THREE -->
